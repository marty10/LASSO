...
while num_cycle < cycles:
    ...
    np.savez(output_folder + "/Enel_cross_val_blocks_direction_single_and_all_levels_threshold_dir" + str(
        threshold_dir) + ".npz", dict_=output_dict, saved_indexes_list=saved_indexes_list, mses=mses,
             weights_list=weights_list,
             XTrain=XTrain, XTest=XTest, YTest=YTest, YTrain=YTrain, XTrainTransf_=XTrain_transf,
             XTestTransf_=XTest_transf, XTrain_ValNoCenter=XTrain_noCenter,
