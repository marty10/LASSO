...
X_transf,dict_sample_turb = enel_transf.transform_versus(X_angle, angles_coord_turb, X_speed, power_curve, Coord, Coord_turb,x_verso, verso_turb_point, threshold_dir)
...
while num_cycle<cycles:
    ...
    np.savez(output_folder+"/Enel_cross_val_blocks_direction_versus_single_all_levels_threshold_dir"+str(threshold_dir)+".npz", dict_ = output_dict,saved_indexes_list = saved_indexes_list, mses = mses, weights_list = weights_list,
