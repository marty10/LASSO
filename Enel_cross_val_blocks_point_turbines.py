...
while num_cycle<cycles:
    ...
    np.savez(output_folder+"/Enel_cross_val_blocks_point_turbines"+str(threshold_dir)+".npz", dict_ = output_dict,saved_indexes_list = saved_indexes_list, mses = mses, weights_list = weights_list,
