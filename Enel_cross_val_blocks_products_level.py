...
while num_cycle<cycles:
    ...
    np.savez("Enel_cross_val_blocks_level_products"+str(k)+".npz", dict_ = dict_,saved_indexes_list = saved_indexes_list, mses = mses, num_informative_list = num_informative_list,
