...
class Enel_scalarKernel(Fit):
    ...
    def fitting(self,XTrain, YTrain, XTest,YTest):
        ...
        XTrain_transf = Scalar_kernel().transform(XTrain_transf)
        XTest_transf = Scalar_kernel().transform(XTest_transf)
        ...
        new_loss, _ = compute_lasso(XTrain_transf, YTrain_, XTest_transf, YTest_, score ="mean_squared_error")
...
class Linear_fit(Fit):
    ...
    def fitting(self, XTrain, YTrain, XTest,YTest ):
        ...
        new_loss, beta = compute_lasso(XTrain_, YTrain_, XTest_, YTest_)
...
class Polynomial_fit(Fit):
    ...
    def fitting(self,XTrain, YTrain, XTest,YTest ):
        ...
        for degree in range(2,5):
            ...
            new_loss, _ =compute_lasso(XTrain_transf, YTrain_, XTest_transf, YTest_)
...
class Log_y_fit(Fit):
    ...
    def fitting(self,XTrain, YTrain, XTest,YTest):
        ...
        new_loss, _ = compute_lasso(XTrain_, YTrain_, XTest_, YTest_)
...
class Log_x_fit(Fit):
    ...
    def fitting(self, XTrain, YTrain, XTest,YTest):
        ...
        new_loss, beta_ordered_values = compute_lasso(XTrain_transf, YTrain_, XTest_transf, YTest_)
